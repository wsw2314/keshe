...
# 加载全量样本
user_log = pd.read_csv('C:/Users/11930/Downloads/data_format1/user_log_format1.csv', dtype={'time_stamp': 'str'})
user_info = pd.read_csv('C:/Users/11930/Downloads/data_format1/user_info_format1.csv')
train_data1 = pd.read_csv('C:/Users/11930/Downloads/data_format1/train_format1.csv')
submission = pd.read_csv('C:/Users/11930/Downloads/data_format1/test_format1.csv')
train_data = pd.read_csv('C:/Users/11930/Downloads/data_format2/train_format2.csv')
...
y_valid = y_valid.astype(int)  # 如果valid_y也需要转换
...
submission.to_csv('C:/Users/11930/Downloads/submission.csv', index=False)